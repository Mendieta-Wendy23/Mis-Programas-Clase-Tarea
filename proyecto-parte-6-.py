...
# --- CLASE MASCOTA:
class Mascota:
    def __init__(self, id_mascota, nombre, especie, edad, tamano, peso, raza, enfermedad, dueno):
...
class Veterinaria:
    ...
    def registrar_mascota(self, nombre, especie, edad, tamano, peso, raza,
        ...
        self.siguiente_id = self.siguiente_id + 1
    ...
    def registrar():
        try:
            ...
            resultado_label.config(
                text="Error: Edad y Peso deben ser números",
                fg="red"
            )

    tk.Label(v1, text="REGISTRAR MASCOTA",
             bg="#ADD8E6",
             font=("Arial", 14, "bold")).pack(pady=5)

    tk.Label(v1, text="--- DATOS MASCOTA ---",
             bg="#ADD8E6",
...
def abrir_buscar():
    ...
    tk.Label(v2, text="BUSCAR MASCOTA",
             bg="#ADD8E6",
             font=("Arial", 14, "bold")).pack(pady=10)

    tk.Label(v2, text="ID de la mascota:",
             bg="#ADD8E6").pack()

    e_buscar = tk.Entry(v2, width=30)
    e_buscar.pack()

    tk.Button(v2, text="Buscar",
              command=buscar,
              bg="white").pack(pady=10)
...
def abrir_vacunar():
    ...
    tk.Label(v3, text="APLICAR VACUNA",
             bg="#ADD8E6",
             font=("Arial", 14, "bold")).pack(pady=10)

    tk.Label(v3, text="ID mascota:",
             bg="#ADD8E6").pack()

    e_id = tk.Entry(v3)
    e_id.pack()

    tk.Label(v3, text="Vacuna aplicada:",
             bg="#ADD8E6").pack()

    e_vacuna = tk.Entry(v3)
    e_vacuna.pack()

    tk.Button(v3, text="Aplicar",
              command=vacunar,
              bg="white").pack(pady=10)
...
def abrir_centros():
    ...
    tk.Label(v4, text="CENTROS DE VACUNACIÓN",
             bg="#ADD8E6",
             font=("Arial", 14, "bold")).pack(pady=10)

    tk.Label(v4, text="Ciudad:",
             bg="#ADD8E6").pack()

    e_ciudad = tk.Entry(v4)
    e_ciudad.pack()

    tk.Button(v4, text="Ver Centros",
              command=ver_centros,
              bg="white").pack(pady=10)
...
def abrir_esterilizar():
    ...
    tk.Label(v6, text="ESTERILIZACIÓN",
             bg="#ADD8E6",
             font=("Arial", 14, "bold")).pack(pady=10)

    tk.Label(v6, text="ID mascota:",
             bg="#ADD8E6").pack()

    e_id = tk.Entry(v6)
    e_id.pack()

    tk.Button(v6, text="Esterilizar",
              command=esterilizar,
              bg="white").pack(pady=10)
...
tk.Button(menu, text="1. Registrar mascota",
          command=abrir_registrar,
          width=25,
          height=2).pack(pady=5)

tk.Button(menu, text="2. Buscar mascota",
          command=abrir_buscar,
          width=25,
          height=2).pack(pady=5)

tk.Button(menu, text="3. Aplicar vacuna",
          command=abrir_vacunar,
          width=25,
          height=2).pack(pady=5)

tk.Button(menu, text="4. Centros de vacunación",
          command=abrir_centros,
          width=25,
          height=2).pack(pady=5)

tk.Button(menu, text="5. Ver descuentos",
          command=abrir_descuentos,
          width=25,
          height=2).pack(pady=5)

tk.Button(menu, text="6. Esterilización",
          command=abrir_esterilizar,
          width=25,
          height=2).pack(pady=5)

tk.Button(menu, text="7. Salir",
          command=menu.destroy,
          width=25,
          height=2,
          bg="#FF6B6B").pack(pady=10)
